...
**New Content Published** — publishing activity. Shows whether the community is producing, not
just consuming. Up is good.
...
lose the adoption you just built. Down is good.
Break down by: Project Name, Workbook Name, Item Type, Status Code Type, Item Owner Email.
...
failures. An early-warning metric. Down is good.
Break down by: Job Type, Schedule Name, Item Type, Owner Email, Final Job Result, Parent Project Name.
